...
python main.py --action=train --dataset=$dataset --split=$split --pooling=$pooling --dropout=$dropout --epoch=$epoch
python main.py --action=predict --dataset=$dataset --split=$split --pooling=$pooling --dropout=$dropout --epoch=$epoch
